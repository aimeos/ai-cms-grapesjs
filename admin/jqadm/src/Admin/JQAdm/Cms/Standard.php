    ...
    implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
    ...
    public function create() : ?string
    {
        ...
        try
        {
            ...
            $data['cms.parentid'] = $view->item->getParentId() ?: $view->param( 'parentid', $view->param( 'item/cms.parentid' ) );
    ...
    public function save() : ?string
    {
        ...
        try
        {
            ...
            return $this->redirect( 'cms', $action, $id, 'save' );
        }
        catch( \Exception $e )
        {
            $manager->rollback();
    ...
    protected function getDomains() : array
    {
         ...
         * list of domains (attribute, media, price, cms, text, etc. are
    ...
    protected function fromArray( array $data ) : \Aimeos\MShop\Cms\Item\Iface
    {
        ...
        if( $item->getId() == null ) {
            return $manager->insert( $item, $data['cms.parentid'] ?: null );
        }
    ...
    protected function toArray( \Aimeos\MShop\Cms\Item\Iface $item, bool $copy = false ) : array
    {
        ...
        {
            $data['cms.id'] = '';
            $data['cms.siteid'] = $item->getSiteId();
            $data['cms.code'] = $data['cms.code'] . '_copy';
        }
