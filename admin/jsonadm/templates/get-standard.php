...
?>
{
	...
	<?php elseif( isset( $this->data ) ) : ?>
		...
		"included": <?= $this->partial( $this->config( $this->get( 'partial-included', 'admin/jsonadm/partials/template-included' ), 'partials/included-standard' ), array( 'childItems' => $this->get( 'childItems', map() ), 'refItems' => $this->get( 'refItems', [] ) ) ); ?>
