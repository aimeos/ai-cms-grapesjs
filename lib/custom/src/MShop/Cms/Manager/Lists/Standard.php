	...
	implements \Aimeos\MShop\Cms\Manager\Lists\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		'cms.lists.id' => array(
			'code' => 'cms.lists.id',
			'internalcode' => 'mcmsli."id"',
			'label' => 'List ID',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
			'public' => false,
		),
		'cms.lists.siteid' => array(
			'code' => 'cms.lists.siteid',
			'internalcode' => 'mcmsli."siteid"',
			'label' => 'List site ID',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'cms.lists.parentid' => array(
			'code' => 'cms.lists.parentid',
			'internalcode' => 'mcmsli."parentid"',
		...
		'cms.lists.key' => array(
			'code' => 'cms.lists.key',
			'internalcode' => 'mcmsli."key"',
			'label' => 'List key',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'cms.lists.type' => array(
			'code' => 'cms.lists.type',
			'internalcode' => 'mcmsli."type"',
			'label' => 'List type',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'cms.lists.refid' => array(
			'code' => 'cms.lists.refid',
			'internalcode' => 'mcmsli."refid"',
			'label' => 'List reference ID',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'cms.lists.datestart' => array(
			'code' => 'cms.lists.datestart',
			'internalcode' => 'mcmsli."start"',
			'label' => 'List start date',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'cms.lists.dateend' => array(
			'code' => 'cms.lists.dateend',
			'internalcode' => 'mcmsli."end"',
			'label' => 'List end date',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'cms.lists.domain' => array(
			'code' => 'cms.lists.domain',
			'internalcode' => 'mcmsli."domain"',
			'label' => 'List domain',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
		),
		'cms.lists.position' => array(
			'code' => 'cms.lists.position',
			'internalcode' => 'mcmsli."pos"',
			'label' => 'List position',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
		),
		'cms.lists.status' => array(
			'code' => 'cms.lists.status',
			'internalcode' => 'mcmsli."status"',
			'label' => 'List status',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
		),
		'cms.lists.config' => array(
			'code' => 'cms.lists.config',
			'internalcode' => 'mcmsli."config"',
			'label' => 'List config',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'cms.lists.ctime' => array(
			'code' => 'cms.lists.ctime',
			'internalcode' => 'mcmsli."ctime"',
			'label' => 'List create date/time',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'cms.lists.mtime' => array(
			'code' => 'cms.lists.mtime',
			'internalcode' => 'mcmsli."mtime"',
			'label' => 'List modify date/time',
			'type' => 'datetime',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
		),
		'cms.lists.editor' => array(
			'code' => 'cms.lists.editor',
			'internalcode' => 'mcmsli."editor"',
			'label' => 'List editor',
			'type' => 'string',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_STR,
			'public' => false,
	 ...
	 * @return \Aimeos\MShop\Cms\Manager\Lists\Iface Manager object for chaining method calls
	 */
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		$path = 'mshop/cms/manager/lists/submanagers';
		foreach( $this->getContext()->getConfig()->get( $path, ['type'] ) as $domain ) {
			$this->getObject()->getSubManager( $domain )->clear( $siteids );
		}

		return $this->clearBase( $siteids, 'mshop/cms/manager/lists/delete' );
	}
	...
	{
		$path = 'mshop/cms/manager/lists/submanagers';
		return $this->getResourceTypeBase( 'cms/lists', $path, [], $withsub );
	}
	...
	/**
	 * Returns a new manager for cms list extensions.
	 *
	...
	public function getSubManager( string $manager, string $name = null ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->getSubManagerBase( 'cms', 'lists/' . $manager, $name );
	}
	...
	protected function getConfigPath() : string
	{
		...
		return 'mshop/cms/manager/lists/';
	}
